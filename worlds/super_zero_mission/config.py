...
import zipfile
from .hack_metadata import import_base_id, import_apworld_name

base_id = import_base_id
...
def load_library() -> None:
    ...
    for file in zip_file.namelist():
        if file.startswith(import_apworld_name+'/hack_randomizer/'):
            new_path = file[len(import_apworld_name):]
