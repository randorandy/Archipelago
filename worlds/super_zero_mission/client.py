...
from .hack_metadata import import_game, import_file_header
...
class HackSNIClient(SNIClient):
    ...
    async def validate_rom(self, ctx: "SNIContext") -> bool:
        ...
        if (
                rom_name is None or
                len(rom_name) != 21 or
                rom_name[0] != ord(import_file_header[0]) or
                rom_name[1] != ord(import_file_header[1]) or
                rom_name[2] < ord("0") or
                rom_name[2] > ord("9")
        ):
            return False
