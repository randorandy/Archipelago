...
from .hack_metadata import import_game, import_early_items, import_file_header
...
class HackWorld(World):
    ...
    def generate_early(self) -> None:
        early_items = import_early_items
    ...
    def generate_output(self, output_directory: str) -> None:
        ...
        rom_name = bytearray(
            f'{import_file_header}{__version__.replace(".", "")[0:3]}_{self.player}_{self.multiworld.seed:11}',
            'utf8'
        )[:21]
