...
energy200 = LogicShortcut(lambda loadout: (
    (loadout.count(Energy) + loadout.count(Reserve)) >= 1
))
...
energy800 = LogicShortcut(lambda loadout: (
    (loadout.count(Energy) + loadout.count(Reserve)) >= 7
))
energy900 = LogicShortcut(lambda loadout: (
    (loadout.count(Energy) + loadout.count(Reserve)) >= 8
))
energy1000 = LogicShortcut(lambda loadout: (
    (loadout.count(Energy) + loadout.count(Reserve)) >= 9
))
energy1200 = LogicShortcut(lambda loadout: (
    (loadout.count(Energy) + loadout.count(Reserve))  >= 11
))
energy1500 = LogicShortcut(lambda loadout: (
    (loadout.count(Energy) + loadout.count(Reserve))  >= 14
))
